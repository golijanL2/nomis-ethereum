...
namespace Nomis.DeFi
{
        ...
        ISingletonService
    {
        ...
        /// <inheritdoc />
        public async Task<Result<IEnumerable<DeFiShieldData>?>> ShieldsAsync(
            DeFiShieldsRequest request)
        {
            try
            {
                ...
                var data = await GetDataAsync<IEnumerable<DeFiShieldData>?>(query, "shields").ConfigureAwait(false);

                return await Result<IEnumerable<DeFiShieldData>?>.SuccessAsync(data, "De.Fi shields data received.").ConfigureAwait(false);
            }
            catch (Exception e)
            {
            ...
            return await Result<IEnumerable<DeFiShieldData>?>.FailAsync(null, "There is an error when getting shields.").ConfigureAwait(false);
        }
